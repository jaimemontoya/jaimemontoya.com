<?php
  $index->content .= 
           "\t\t\t<div>
				...
				<p>The first chapter provides information about the socioeconomic, cultural, political, educational and familiar background that nurtured Robert Oppenheimer.</p>
