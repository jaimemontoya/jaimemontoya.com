...
class HomePage extends Page
{
  ...
  public function RichestCompaniesAndPeopleCharts()
  {
    ...
    echo "\t\t\t\t\t[new Date(2024, 11 , 6), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 7), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 8), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 9), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 10), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 11), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 12), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 13), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 14), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 15), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 16), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 17), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 18), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 19), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 20), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 21), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 22), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 23), 6573.68],\n";
    echo "\t\t\t\t\t[new Date(2024, 11 , 24), 6573.68]\n";
    echo "\t\t\t\t]);\n";
    echo "\t\t\t\tvar options = {\n";
