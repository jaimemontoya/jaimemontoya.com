<?php
  ...
  <table>
    ...
    <tr>
	  ...
	  <td>Sat Jun 28 08:04:00 2025 -0600</td>
    </tr>
    <tr>
  ...
  <p>Welcome to my website, whose code has been written by myself, from scratch, and it is entirely available on GitHub at <a href=\"https://github.com/jaimemontoya/jaimemontoya.com\">https://github.com/jaimemontoya/jaimemontoya.com</a>. My introduction is this inspiring story: Spaniard Pablo de Sarasate, internationally acclaimed as the greatest violinist of the nineteenth century, was once called a genius by a famous critic. In reply to this Sarasate said, <span class=\"cod\">\"Genius! For 37 years I've practiced 14 hours a day, and now they call me a genius.\"</span></p>
  <h2>Mission</h2><p>To create Blue Chip Finances, an open-source personal financial management (PFM) software that helps people to be free from financial debt and achieve greatness in their personal finances.</p><h2>Vision</h2><p>To pursue a future where individuals are empowered to be free from financial debt and achieve financial greatness through disciplined long term blue chip stock investing.</p><h2>Values</h2><ul><li>Discipline<li>Laser focus<li>Patience</ul>
