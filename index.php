<?php
  require("home.php");
  $index = new HomePage();
  $index->content .= "<h1 class=\"center\">Jaime Montoya's net worth as of 14 June 2026: <span class=\"cod\">38,046.51 USD</span> <a href=\"about/\">About Jaime Montoya</a></h1>
  ...
  <p>Following my investment philosophy, if I were to buy stocks today 18 June 2026, Nvidia Corporation (NVDA) is the company where I would invest it all:</p>
