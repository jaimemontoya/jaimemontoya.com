<?php
  require("home.php");
  $index = new HomePage();
  $index->content .= "<h1 class=\"center\">Jaime Montoya's net worth as of 13 May 2026: <span class=\"cod\">39,530.13 USD</span> <a href=\"about/\">About Jaime Montoya</a></h1>
  <h2>R&D: <a href=\"https://www.coursera.org/learn/microsoft-azure-cosmos-db\">Microsoft Azure Cosmos DB</a></h2>
  <hr>
  ...
  <p>Following my investment philosophy, if I were to buy stocks today 13 May 2026, Nvidia Corporation (NVDA) is the company where I would invest it all:</p>
