<?php
  require("home.php");
  $index = new HomePage();
  $index->content .= "<h1 class=\"center\">Jaime Montoya's net worth as of 27 June 2026: <span class=\"cod\">19,328.07 USD</span></h1>
  <hr>
  ...
  <p>Following my investment philosophy, if I were to buy stocks today 28 June 2026, Nvidia Corporation (NVDA) is the company where I would invest it all:</p>
