<?php
  require("home.php");
  $index = new HomePage();
  $index->content .= "<h1 class=\"center\">Jaime Montoya's net worth as of 23 June 2026: <span class=\"cod\">37,073.3 USD</span></h1>
  <hr>
  ...
  <p>Following my investment philosophy, if I were to buy stocks today 23 June 2026, Nvidia Corporation (NVDA) is the company where I would invest it all:</p>
