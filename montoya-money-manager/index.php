...
<html>
	...
	<body>		
		...
		$totalSales = $conn->query($sqlTotalSales);
		...
		$result = $conn->query($sql);
		if ($result->num_rows > 0) {
			echo "<table><tr><th>Description</th><th>Date</th><th>City</th><th>Payment method</th><th>Buyer</th><th>Category</th><th>Total = ".$sqlTotalSales->fetch_assoc()["TotalSales"]."</th></tr>";			
			while($row = $result->fetch_assoc()) {
