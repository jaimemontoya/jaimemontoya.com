...
class Page
{
  ...
  public $buttons = array("<i class=\"fa-light fa-house\"></i>" => "/", "<i class=\"fa-brands fa-linkedin\"></i>" => "/resume/", "<i class=\"fa-solid fa-money-check-dollar\"></i>" => "/resume/", "<i class=\"fa-brands fa-github\"></i>" => "https://github.com/jaimemontoya/jaimemontoya.com/");
