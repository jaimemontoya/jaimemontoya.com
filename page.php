...
class Page
{
  ...
  public $buttons = array("<i class=\"fa-solid fa-house-user\"></i>" => "/", "<i class=\"fa-sharp fa-solid fa-file-user\"></i>" => "/resume/", "<i class=\"fa-solid fa-money-check-dollar\"></i>" => "/resume/", "<i class=\"fa-brands fa-github\"></i>" => "https://github.com/jaimemontoya/jaimemontoya.com/");
