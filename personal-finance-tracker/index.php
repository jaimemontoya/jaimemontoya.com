	...
	<body>
		...
		if ($result->num_rows > 0) {
			...
			while($row = $result->fetch_assoc()) {
				echo "<tr><td>" . $row["Description"]. "</td><td>" . $row["DateKey"]. " " . $row["CityName"]. "</td><td>" . $row["PaymentMethodName"]. " " . $row["BuyerName"]. "</td><td>" . $row["Category"]. " " . $row["TotalSales"]. "</td></tr>";print_r($row);
			}
			echo "</table>";
		} else {
			echo "0 results";
