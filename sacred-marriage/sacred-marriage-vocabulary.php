<?php
  $index->content .= 
           "\t\t\t<ul>
				...
				<li>For thousands of years, physicians had speculated on what went on inside a human body, but there was a reluctance and even an <mark>abhorrence</mark> to actually <mark>dissect</mark> a cadaver.
			</ul>\n";
?>